...
" document library
nnoremap <silent><buffer> K :<C-u>call vimproc#system('~/tools/hsp3/hdl.exe ' . expand('<cword>'))<CR>
vnoremap <silent><buffer> K :<C-u>call vimproc#system('~/tools/hsp3/hdl.exe ' . expand('<cword>'))<CR>
