...
" document library
nnoremap <silent><buffer> K :<C-u>call vimproc#system('D:/tools/hsp3/hdl.exe ' . expand('<cword>'))<CR>
vnoremap <silent><buffer> K :<C-u>call vimproc#system('D:/tools/hsp3/hdl.exe ' . expand('<cword>'))<CR>
